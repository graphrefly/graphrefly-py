---
name: parity
description: "Cross-language parity check between graphrefly-py and graphrefly-ts. Run after /dev-dispatch + /qa on both repos to catch behavioral divergences. Use when user says 'parity', 'cross-lang check', or 'sync repos'."
